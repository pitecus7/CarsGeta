...
namespace KartGame.AI
{
    ...
    public class KartAgent : Agent, IInput
    {
        ...
        private void Start()
        {
            GameFlowManager.onMapLoad += MapLoad;
        }
        ...
        void SetUp()
        {
            if (FindObjectOfType<DebugCheckpointRay>().Colliders != null)
            {
                Colliders = FindObjectOfType<DebugCheckpointRay>().Colliders;
            }
            ...
            {
                switch (GameManager.Instance.gameInformation.difficulty)
                {
                    case Difficulty.easy:
                        kart.skinnedMeshRenderer.material.color = GameManager.Instance.characters[0].color;
                        kart.baseStats.Acceleration = GameManager.Instance.characters[0].aceleration;
                        kart.baseStats.TopSpeed = GameManager.Instance.characters[0].speed;
                        break;
                    case Difficulty.normal:
                        kart.skinnedMeshRenderer.material.color = GameManager.Instance.characters[3].color;
                        kart.baseStats.Acceleration = GameManager.Instance.characters[3].aceleration;
                        kart.baseStats.TopSpeed = GameManager.Instance.characters[3].speed;
                        break;
                    case Difficulty.hard:
                        kart.skinnedMeshRenderer.material.color = GameManager.Instance.characters[2].color;
                        kart.baseStats.Acceleration = GameManager.Instance.characters[2].aceleration;
                        kart.baseStats.TopSpeed = GameManager.Instance.characters[2].speed;
                        break;
                }
            }
        ...
        public override void AgentReset()
        {
            switch (Mode)
            {
                case AgentMode.Training:
                    checkpointIndex = UnityEngine.Random.Range(0, Colliders.Length - 1);
